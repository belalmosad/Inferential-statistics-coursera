...
```{r set-seed}
set.seed(147)                 # make sure to change the seed
```
...
samp %>%
  ggplot(aes(x = area)) + geom_histogram()
...
# type your code for the Exercise here, and Knit
params # Equals to  1500
# The lower & upper values of intervals = 1286 & 1604
# So, yes it seems that the confidence intervals captured it.
```
